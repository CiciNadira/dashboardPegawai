...
$kategori = 'BMN';
$judul_page = 'Laporan BMN';

$data_laporan = query("SELECT * FROM data_laporan WHERE kategori = '$kategori' ORDER BY id DESC");

if (isset($_POST["simpan_data"])) {
    if (tambahLaporan($_POST) > 0) {
        echo "<script>alert('Laporan berhasil diupload!'); window.location.href='bmn.php';</script>";
    }
}

if (isset($_GET["hapus"])) {
    if (hapusLaporan($_GET["hapus"]) > 0) {
        echo "<script>alert('Laporan dihapus!'); window.location.href='bmn.php';</script>";
    }
}
?>
                ...
                <div class="add-modal-content" style="max-width:500px; background:#fff; color:#111;">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" required placeholder="Contoh: Laporan BMN Bulan Januari" style="width:100%; padding:10px; border-radius:8px; border:1px solid #ccc;">
                        </div>
