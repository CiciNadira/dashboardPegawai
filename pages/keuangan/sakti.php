...
$jenis_aplikasi = "Sakti"; 
$judul_halaman  = "Keuangan - Aplikasi SAKTI";

$data_keuangan = query("SELECT * FROM data_keuangan WHERE jenis_aplikasi = '$jenis_aplikasi' ORDER BY id DESC");

if (isset($_POST["simpan_data"])) {
    if ($_POST['id'] != "") {
        if (ubahKeuangan($_POST) > 0) echo "<script>alert('Data berhasil diupdate!'); location.href='sakti.php';</script>";
        else echo "<script>alert('Gagal/Tidak ada perubahan!'); location.href='sakti.php';</script>";
    } else {
        if (tambahKeuangan($_POST) > 0) echo "<script>alert('Data berhasil disimpan!'); location.href='sakti.php';</script>";
    }
}

if (isset($_GET["hapus"])) {
    if (hapusKeuangan($_GET["hapus"]) > 0) echo "<script>alert('Data berhasil dihapus!'); location.href='sakti.php';</script>";
    else echo "<script>alert('Gagal menghapus data!'); location.href='sakti.php';</script>";
}
?>
                ...
                <div class="add-modal-content" style="max-width:500px; background:#fff; color:#111;">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="uraian" id="addUraian" required placeholder="Contoh: Input Data Sakti" style="width:100%; padding:10px; border:1px solid #ccc; border-radius:8px;">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                ...
                <?php else : ?>
                    ...
                    <div class="doc-card">
                        ...
                        <div class="card-actions">
                            ...
                            <a href="sakti.php?hapus=<?= $row['id']; ?>" class="btn-act btn-del" onclick="return confirm('Yakin ingin menghapus data ini?');" title="Hapus Data">
