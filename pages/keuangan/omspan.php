                ...
                <div class="add-modal-content" style="max-width:500px; background:#fff; color:#111;">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="uraian" id="addUraian" required placeholder="Contoh: Input Data Omspan" style="width:100%; padding:10px; border:1px solid #ccc; border-radius:8px;">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
